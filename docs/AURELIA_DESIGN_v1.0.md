...
---
# TODO: Get rid of sections 1.0, 1.1 1.2. My reasoning is that we aren't necessarily sticking to this design right now. This is more of a stretch goal that doesn't pertain to the current philosophy of the game.
...
# TODO: This is now explicitly forbidden as the agent will reflexively read it's own information whcih is bad.
...
# Let's stick to the YAGNI principle and 86 this for now.
